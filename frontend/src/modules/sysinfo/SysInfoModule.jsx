...
export default function SysInfoModule() {
    ...
    useEffect(() => {
        const fetchInfo = () => {
            // Check if GetSysInfo is available (user needs to run wails generate module)
    ...
    return (
        <div className="w-80 relative flex flex-col rounded-2xl mx-auto overflow-hidden bg-slate-950/80 backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] p-4 text-white">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-bold bg-linear-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">System Monitor</h2>
